...
#Function to view the tic tac board, different styles can be used
...
#Funvtion to place the markers on the board
def placement(board, mark, position):
    board[position]=mark

#Function that checks the board for 3 in a row
...
#Function to define who will go first 
def turn():
...
#Function to choose position on the board
def choice(board):
    pos = 0
